            ...
            <div className="lg:col-span-3 p-10 lg:p-14">
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-[#ff9933] focus:border-transparent transition-all outline-none bg-white">
